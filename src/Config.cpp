...
AutoTaxiConfig loadAutoTaxiConfig(const std::string& iniPath, std::string& error) {
    ...
    cfg.trackCourseControl = ini.getBool("track_course_control", cfg.trackCourseControl);
    cfg.trackCourseBlend = ini.getDouble("track_course_blend", cfg.trackCourseBlend);
    cfg.trackCourseLookaheadM = ini.getDouble("track_course_lookahead_m", cfg.trackCourseLookaheadM);
    cfg.trackCourseSpeedGainMPerKt = ini.getDouble("track_course_speed_gain_m_per_kt", cfg.trackCourseSpeedGainMPerKt);
    cfg.trackCourseGain = ini.getDouble("track_course_gain", cfg.trackCourseGain);
    cfg.trackCourseMaxInterceptDeg = ini.getDouble("track_course_max_intercept_deg", cfg.trackCourseMaxInterceptDeg);
    cfg.trackCoursePrezeroBandM = ini.getDouble("track_course_prezero_band_m", cfg.trackCoursePrezeroBandM);
    cfg.trackCoursePrezeroLeadSec = ini.getDouble("track_course_prezero_lead_sec", cfg.trackCoursePrezeroLeadSec);
    cfg.trackCoursePrezeroPower = ini.getDouble("track_course_prezero_power", cfg.trackCoursePrezeroPower);
    cfg.trackCoursePrezeroMinHeadingDeg = ini.getDouble("track_course_prezero_min_heading_deg", cfg.trackCoursePrezeroMinHeadingDeg);
    cfg.trackCoursePrezeroCounterM = ini.getDouble("track_course_prezero_counter_m", cfg.trackCoursePrezeroCounterM);
    cfg.trackCourseTightTurnFade = ini.getDouble("track_course_tight_turn_fade", cfg.trackCourseTightTurnFade);
    cfg.xteCorridorControl = ini.getBool("xte_corridor_control", cfg.xteCorridorControl);
    cfg.xteCorridorM = ini.getDouble("xte_corridor_m", cfg.xteCorridorM);
    cfg.xteFineTuneM = ini.getDouble("xte_fine_tune_m", cfg.xteFineTuneM);
    cfg.xteCorridorOuterGain = ini.getDouble("xte_corridor_outer_gain", cfg.xteCorridorOuterGain);
    cfg.xteCorridorInnerGain = ini.getDouble("xte_corridor_inner_gain", cfg.xteCorridorInnerGain);
    cfg.xteCorridorMaxInterceptDeg = ini.getDouble("xte_corridor_max_intercept_deg", cfg.xteCorridorMaxInterceptDeg);
    cfg.xteCorridorOuterMaxInterceptDeg = ini.getDouble("xte_corridor_outer_max_intercept_deg", cfg.xteCorridorOuterMaxInterceptDeg);
    cfg.xteCorridorLeadSec = ini.getDouble("xte_corridor_lead_sec", cfg.xteCorridorLeadSec);
    cfg.xteCorridorPrezeroReturnDeg = ini.getDouble("xte_corridor_prezero_return_deg", cfg.xteCorridorPrezeroReturnDeg);
    cfg.xteCorridorKpScale = ini.getDouble("xte_corridor_kp_scale", cfg.xteCorridorKpScale);
    cfg.xteCorridorKdBoost = ini.getDouble("xte_corridor_kd_boost", cfg.xteCorridorKdBoost);
    cfg.xteCorridorCaptureFade = ini.getDouble("xte_corridor_capture_fade", cfg.xteCorridorCaptureFade);
    cfg.swayDampingBandM = ini.getDouble("sway_damping_band_m", cfg.swayDampingBandM);
    cfg.swayDampingCommandScale = ini.getDouble("sway_damping_command_scale", cfg.swayDampingCommandScale);
    cfg.swayDampingSteerRatePerSec = ini.getDouble("sway_damping_steer_rate_per_sec", cfg.swayDampingSteerRatePerSec);
    cfg.earlyTurnTakeover = ini.getBool("early_turn_takeover", cfg.earlyTurnTakeover);
    cfg.earlyTurnTakeoverAngleDeg = ini.getDouble("early_turn_takeover_angle_deg", cfg.earlyTurnTakeoverAngleDeg);
    cfg.earlyTurnTakeoverDistanceM = ini.getDouble("early_turn_takeover_distance_m", cfg.earlyTurnTakeoverDistanceM);
    cfg.earlyTurnFullDistanceM = ini.getDouble("early_turn_full_distance_m", cfg.earlyTurnFullDistanceM);
    cfg.earlyTurnMinBlend = ini.getDouble("early_turn_min_blend", cfg.earlyTurnMinBlend);
    cfg.earlyTurnHeadingBlend = ini.getDouble("early_turn_heading_blend", cfg.earlyTurnHeadingBlend);
